    ...
    <div className="min-h-screen flex justify-center items-center bg-gradient-to-br from-slate-50 via-white to-slate-50">
      <div className="w-full   max-w-md bg-white rounded-lg shadow-lg p-8 m-5">
        ...
        <div className=" flex flex-col items-center text-center mb-6">
          <div className="text-white  bg-purple-500 p-4 rounded-lg">
          ...
          {/*username*/}
            ...
            <div className="relative flex items-center ">
              <div className={`absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none duration-200
                ${focusField ==="username"?'text-purple-500':'text-slate-500'} `}>
              <User size={18} />  
              </div>
              <input
                type="text"
                ...
                value={username}
                className="w-full h-12 pl-10 outline-none border-2 rounded-md px-2 mt-1 border-slate-200 focus:text-purple-500 focus:border-purple-500"
...
<div>
  ...
  <div className="relative flex items-center">
    ...
    <input
      ...
      placeholder="****"
      value={password}
      className="w-full h-12 pl-10 pr-10 outline-none border-2 rounded-md px-2 mt-1 border-slate-200 focus:text-purple-500 focus:border-purple-500"
    ...
    <button
      ...
      className="absolute inset-y-0 right-0 pr-3 flex items-center text-slate-500 hover:text-purple-500"
    >
      {showPassword ? <EyeOff size={18} /> : <Eye size={18}/>}
          ...
          {/* Button */}
          <button
            className="w-full flex items-center justify-center gap-2 bg-purple-500 font-bold text-[17px] text-white py-2 rounded-md hover:bg-purple-400 transition"
        ...
        <div className="mt-6 text-center text-1xl">
          <p>
            ...
            <Link to="/login" className="text-blue-600 hover:text-purple-500">
              Sign in
            </Link>
          </p>
        </div>
